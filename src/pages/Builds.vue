<template>
    <Layout>
        <div class="h-full" style="background: #121313;">
            ...
            <div class="grid gap-4 m-4" style="grid-template-columns: repeat(auto-fill, minmax(350px, 1fr));" v-else>
                <div v-for="(build, index) in builds" :key="index" class="text-gray-400 p-4 border border-gray-600 rounded-lg hover:border-gray-300 cursor-pointer builds group" @click="$router.push({path:'/build/'+index})" >
